...
#ifdef __LP64__
#define vDSP_vsadd vDSP_vsaddD
#define vDSP_vsub vDSP_vsubD
#define vDSP_vclip vDSP_vclipD
#define vDSP_polar vDSP_polarD
#define vDSP_svdiv vDSP_svdivD
#define vDSP_rect vDSP_rectD
#endif
...
- (void)addPoint:(CGPoint)point
     toPositions:(CGPoint *)positions
           count:(NSUInteger)count
{
    CGFloat *xStart = (CGFloat *)positions;
    CGFloat *yStart = xStart + 1;
...
- (void)adjustViewPositions:(CGPoint *)positions count:(NSUInteger)count forTouchPoint:(TouchPoint *)touchPoint
{
    ...
    CGFloat scale = touchPoint.scale;
    ...
    // Apply adjustment
    vDSP_vsub(adjustment, 1, (CGFloat *)positions, 1, (CGFloat *)positions, 1, count * 2);
}
...
- (void)setAttributedString:(NSAttributedString *)attributedString
{
    if (attributedString != _attributedString) {
        ...
        CTTypesetterRef typesetter = CTTypesetterCreateWithAttributedString((__bridge CFTypeRef)_attributedString);
